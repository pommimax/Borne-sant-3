                ...
                <div id="conteneur">
                    <div id="droite12">
                        ...
                        <table style="line-height: 150%;margin-left:33%;margin-right:25%" cellspacing="30">
                            ...
                            <tr>
                                <td><input type="radio" name="Tabac" id="TbcID1" value = "Oui" onclick="Animer('avatarT12','non')"></td>
                                <td><label for="Oui">Oui</label></td>
                            </tr>

                            <tr>
                                <td><input type="radio" name="Tabac" id="TbcID2" value = "Non" onclick="Animer('avatarJ12','non')"></td>
                                <td><label for="Non">Non</label></td>
                            </tr>

                            <tr>
                                <td><input type="radio" name="Tabac" id="TbcID3" value = "Occasionnellement" onclick="Animer('avatarJ12','non')"></td>
                                <td><label for="Occasionnellement">Occasionnellement</label></td>
                            </tr>
